;(function(){
    ...
    app.controller("index",["$scope","$rootScope","$http","HOST","device","$state","$timeout","toast",
        function($scope,$rootScope,$http,HOST,device,$state,$timeout,toast){
            ...
            $scope.$on("scroll", function(event,data) {
                if(window.innerHeight + document.body.scrollTop > document.querySelector("#index").offsetHeight - 1){
